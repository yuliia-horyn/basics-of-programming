...
values ('Спорт', '/dev/static/images/categories/sport.svg', '#1890FF', '#1890FF', '#fff'),
       ('Танці', '/dev/static/images/categories/dance.svg', '#531DAB', '#F9F0FF', '#531DAB'),
       ('Студії раннього розвитку', '/dev/static/images/categories/improvement.svg', '#73D13D', '#73D13D', '#fff'),
       ('Наука, технології, STEM', '/dev/static/images/categories/programming.svg', '#597EF7', '#597EF7', '#fff'),
       ('Образотворче мистецтво, живопис, скульптура', '/dev/static/images/categories/art.svg', '#9254DE', '#9254DE', '#fff'),
       ('Вокальне мистецтво, музика, музичні інструменти', '/dev/static/images/categories/music.svg', '#FF7A45', '#FF7A45', '#fff'),
       ('Театральне мистецтво, кінодрама', '/dev/static/images/categories/theatre.svg', '#FF4D4F', '#FF4D4F', '#fff'),
       ('Особистісний розвиток', '/dev/static/images/categories/self-improvement.svg', '#FADB14', '#FFF9D4', '#D46B08'),
       ('Телебачення, журналістика, кіно, фотографія', '/dev/static/images/categories/tv.svg', '#13C2C2', '#13C2C2', '#fff'),
       ('Їжа', '/dev/static/images/categories/food.svg', '#FFA940', '#FFA940', '#fff'),
...
values (6, 9, 'Довкілля крізь призму української мови 1', 'вул. Університетська 52', '#', '#', 'dev/static/images/club/bg_2.png', '09:00-16:00', 50.4501,
       ...
       (6, 9, 'Довкілля крізь призму української мови 4', 'вул. Університетська 52', '#', '#', 'dev/static/images/club/bg_4.jpg', '09:00-16:00', 46.492841277008196,
        30.746685697230422, 4, 4, 4, null, 2,
